...
$(document).ready(function () {
  ...
  let {isDarkTheme, themeMode} = {isDarkTheme: true, themeMode: 1}; /*主题初始化,有修改*/
...
$(window).on('load', function () {
  ...
  isotopeInstances.forEach(function (isotopeInstance, index) {
    ...
    //===============此处有修改=====================begin
    if (isoSection == null || isoSection == undefined || isoSection == NaN || isoSection.length <= 0) {
      isoSection = isotopeInstance.closest('body');
    }
    //===============此处有修改=====================end
    let layout = '';
